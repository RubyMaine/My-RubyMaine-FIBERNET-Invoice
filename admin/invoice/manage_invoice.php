...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Update Invoice - ".$invoice_code : 'Создать новый счет' ?></h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="client_id" class="control-label text-info"> Клиент </label>
                                <select name="client_id" id="client_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Пожалуйста, выберите клиента здесь" required>
                                    <option <?php echo !isset($client_id) ? "selected" : '' ?> Инвалидный ></option>
                                    <?php 
                    ...
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row align-items-end">
                            <div class="form-group col-sm-4">
                                <label for="service_id" class="control-label text-info">Обслуживание</label>
                                <select id="service_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Пожалуйста, выберите услугу здесь">
                                    <option <?php echo !isset($service_id) ? "selected" : '' ?> Инвалидный ></option>
                                    <?php 
                                    $service_arr = array();
                            ...
                            <div class="form-group col-sm-4">
                               <button class="btn btn-flat btn-primary btn sm" type="button" id="add_to_list"><i class="fa fa-plus"></i> Добавить в список </button>
                            </div>
                        </div>
                        <table class="table table-hover table-striped table-bordered" id="service-list">
                            ...
                            <thead>
                                <tr class="bg-lightblue text-light">
                                    ...
                                    <th class="px-2 py-2 text-center"> Обслуживание: </th>
                                    <th class="px-2 py-2 text-center"> Описание: </th>
                                    <th class="px-2 py-2 text-center"> Цена: </th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php 
                            ...
                            <tfoot>
                                ...
                                <tr class="bg-lightblue text-light disabled">
                                    <th class="px-2 py-2 text-right" colspan="3">
                                        Налоги <small><i>(включительно):</i></small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="remarks" class="control-label text-info"> Примечания: </label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="custom-select selevt">
                                    <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>> Оплаченный </option>
                                    <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>> В ожидании </option>
                                </select>
                            </div>
                            <?php endif; ?>
                        </div>
    ...
    <div class="card-footer text-center">
        <a class="btn btn-flat btn-sn btn-danger" href="<?php echo base_url."admin?page=invoice" ?>"> Отмена </a>
        <button class="btn btn-flat btn-sn btn-success" type="submit" form="invoice-form"> Сохранить </button>
    </div>
</div>
