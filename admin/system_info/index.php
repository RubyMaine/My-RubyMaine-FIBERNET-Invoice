...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title"><i class="nav-icon fas fa-cogs"></i> Настройка системная информация </h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label"> Наименование система </label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label"> Краткое имя системы </label>
			...
			<div class="form-group">
				<label for="" class="control-label">Логотип системы</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Фон входа</label>
				<div class="custom-file">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Обновлять</button>
				</div>
			</div>
		</div>
