...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><i class="nav-icon fas fa-list"></i> Список услуг </h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Создать новый услуг </a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Service Detials","maintenance/manage_service.php?id="+$(this).attr('data-id'),"mid-large")
		})
