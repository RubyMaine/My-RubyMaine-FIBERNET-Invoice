...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"> Сведения о счете </h5>
    </div>
    <div class="card-body">
        <div class="container-fluid" id="print_out">
            ...
            <h3 class="text-info"> Счет: <b><?php echo isset($invoice_code) ? $invoice_code :'' ?></b></h3>
            ...
            <fieldset class="border-bottom border-info">
                ...
                <table class="table table-hover table-striped table-bordered" id="service-list">
                    ...
                    <tfoot>
                        ...
                        <tr class="bg-lightblue text-light disabled">
                            <th class="px-2 py-2 text-right" colspan="3">
                                Скидка (<?php echo isset($discount_perc) ? $discount_perc : 0 ?>%)
                            </th>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="status" class="control-label text-info">Статус платежа</label>
                        <div class="pl-4">
                            <?php if($status == 1): ?>
                                <span class="badge badge-pill badge-success">Оплаченный</span>
                            <?php else: ?>
    ...
    <div class="card-footer text-center">
            <button class="btn btn-flat btn-sn btn-success" type="button" id="print"><i class="fa fa-print"></i> Распечатать </button>
            <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."?page=invoice_list" ?>"> Обратно к списку </a>
    </div>
</div>
<script>
    $(function(){
